                  ...
                  <div className={styles.teamInfo}>
                    ...
                    <div className={styles.socialShare}>
                      <ul className={styles.socialIcon}>
                        <li className={styles.socialIconItem}>
                          <a
                            href="https://instagram.com/dedytbng"
                            className={styles.socialIconLink}
                          >
                            <Image src={instagram} alt="" />
                          </a>
                        ...
                        <li className={styles.socialIconItem}>
                          <a
                            href="https://github.com/Dedytobing"
                            className={styles.socialIconLink}
                          >
                            <Image src={github} alt="" />
                          </a>
                        ...
                        <li className={styles.socialIconItem}>
                          <a
                            href="https://www.facebook.com/dedy.lumbantobing.7"
                            className={styles.socialIconLink}
                          >
                        ...
                        <li className={styles.socialIconItem}>
                          <a
                            href="https://www.linkedin.com/in/dedy-lumbantobing"
                            className={styles.socialIconLink}
                          >
                            <Image src={linkedin} alt="" />
                          </a>
                  ...
                  <div className="p-5 text-md-left">
                    ...
                    <ul className={styles.misiList}>
                      ...
                      <li className={styles.textJustify}>
                        ...
                        pembelajaran, serta bagaimana kontribusi positif ini
                        dapat membentuk perkembangan generasi muda.
                      </li>
                    </ul>
                  </div>
                </div>
